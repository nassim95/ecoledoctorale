...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><c:url value="/ajouter etudiant/"
					var="ajouter etudiant" /> <a class="nav-link"
				href="ajouteretudiant"> <i class="fas fa-fw fa-tachometer-alt"></i>
					<span>Ajouter Etudiant</span></a></li>
			...
			<li class="nav-item"><c:url value="/ajouter module/"
					var="ajouter module" /> <a class="nav-link collapsed"
				href="ajoutermodule" data-toggle="collapse"
				data-target="#collapseTwo" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-fw fa-cog"></i> <span>Ajouter
						Module</span>
			</a>
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item"
							href="<%request.getContextPath();%>buttons.html">Buttons</a> <a
							class="collapse-item"
							href="<%request.getContextPath();%>cards.html">Cards</a>
					</div>
				</div></li>

			<!-- Nav Item - Utilities Collapse Menu -->
			<li class="nav-item"><c:url value="/ajouter evenement/"
					var="ajouter evenement" /> <a class="nav-link collapsed"
				href="ajouterevenement" data-toggle="collapse"
				data-target="#collapseUtilities" aria-expanded="true"
				aria-controls="collapseUtilities"> <i
					class="fas fa-fw fa-wrench"></i> <span> Ajouter Evenement</span>
			</a>
			...
			<li class="nav-item"><c:url value="/ajouter liste/"
					var="ajouter liste" /> <a class="nav-link collapsed"
				href="ajouterliste" data-toggle="collapse"
				data-target="#collapseUtilities" aria-expanded="true"
				aria-controls="collapseUtilities"> <i
					class="fas fa-fw fa-wrench"></i> <span> Ajouter Liste
						Etudiant</span>
			</a>
				<div id="collapseUtilities" class="collapse"
					aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<br> <br> <br> <br>
					<h1 style="color: red;">PAGE ADMINISTRATIVE</h1>
					_________________________________________________________________________________
					_________________________________________________________________________________
					<h3 style="color: blue;">-Ajouter liste-</h3>
				<a style="color: black;" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="#"><i class="fas fa-download fa-sm text-white-50"></i> LISTE_CANDIDATS</a>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary"
						href="<%request.getContextPath();%>login.html">Logout</a>
				</div>
			</div>
		</div>
	</div>
